...
class crm_phonecall_report(osv.osv):
    ...
    _name = "crm.phonecall.cicca.report"
    _description = "Phone calls by user, estado and section"
    _auto = False
    ...
    _columns = {
        ...
        'estado': fields.selection(
            [('10 - PLA','PLA - Planificado'),
             ('20 - CON', 'CON - Contactado'),
             ('30 - NC', 'NC - No Contactado'),
             ('40 - NEI', 'NEI - No Interesado'),
             ('50 - NCN', 'NCN - No Contesta'),
             ('60 - NI', 'NI - Numero Incorrecto'),
             ('70 - LO', 'LO - Linea Ocupada'),
             ('80 - REC', 'REC - Reclamo'),
             ('90 - OK', 'OK - Venta')
    ...
    def init(self, cr):
        ...
        """
        tools.drop_view_if_exists(cr, 'crm_phonecall_cicca_report')
        cr.execute("""
            create or replace view crm_phonecall_cicca_report as (
                select
                    id,
